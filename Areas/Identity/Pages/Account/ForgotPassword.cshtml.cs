    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                string emailString = $"Please reset your password by clicking the following link: '{HtmlEncoder.Default.Encode(callbackUrl)}'";
                EmailService.SendResetPasswordEmailAsync(Input.Email, emailString).Wait();
